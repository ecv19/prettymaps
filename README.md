...
```
    ...
    Fetching geodataframes took 5.34 seconds
...
```
    ...
    Fetching geodataframes took 41.88 seconds
...
```
    ...
    Fetching geodataframes took 15.32 seconds
...
```
    ...
    Fetching geodataframes took 14.50 seconds
...
```
    ...
    Fetching geodataframes took 13.58 seconds
...
```
    ...
    Fetching geodataframes took 30.26 seconds
...
```
    ...
    Fetching geodataframes took 11.30 seconds


    Fetching geodataframes took 6.79 seconds


    Fetching geodataframes took 10.29 seconds
...
```
    ...
    Fetching geodataframes took 51.25 seconds
    ...
    make: Leaving directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
    make: Entering directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
    cp SRTM1.vrt SRTM1.bffa2096789941e096dfde310807f2cc.vrt
    make: Leaving directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
    make: Entering directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
    gdal_translate -q -co TILED=YES -co COMPRESS=DEFLATE -co ZLEVEL=9 -co PREDICTOR=2 -projwin -157.90125854957773 21.364471426268267 -157.81006761682832 21.244615177105388 SRTM1.bffa2096789941e096dfde310807f2cc.vrt /home/runner/work/prettymaps/prettymaps/notebooks/elevation.tif
    rm -f SRTM1.bffa2096789941e096dfde310807f2cc.vrt
    make: Leaving directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
...
```
    ...
    Fetching geodataframes took 17.92 seconds
